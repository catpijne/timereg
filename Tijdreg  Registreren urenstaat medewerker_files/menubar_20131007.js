...
function HideAllSelects () {
  for (i = 0; i < document.forms.length; i++) {
    for (j = 0; j < document.forms[i].length; j++) {
      if (document.forms[i][j].nodeName == 'SELECT') { document.forms[i][j].style.visibility = 'hidden'; }
    }
  }
}
function UnHideAllSelects () {
  for (i = 0; i < document.forms.length; i++) {
    for (j = 0; j < document.forms[i].length; j++) {
      if (document.forms[i][j].nodeName == 'SELECT') { document.forms[i][j].style.visibility = ''; }
    }
  }
}
//
...
function pageMousedown (event) {
  ...
  if (className != 'menuButton' && className != 'menuItem' &&
      ...
      activeButton) { resetButton(activeButton); }
}
...
function depressButton (button) {
  ...
  if (browser_is_IE6 == true) { HideAllSelects(); }
}
...
function resetButton (button) {
  ...
  if (browser_is_IE6 == true) { UnHideAllSelects(); }
}
