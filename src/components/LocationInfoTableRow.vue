<template>
    <tr class="UI_locationInfo">
      <td class="locationName"><input type="text" v-bind:value="name"></td>
      <td class="KM"><input type="text" v-bind:value="km"></td>
      <td class="Comment"><input type="text" v-bind:value="comment"></td>
